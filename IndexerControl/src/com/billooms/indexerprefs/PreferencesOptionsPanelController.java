...
iconBase = "com/billooms/indexerprefs/Hardware32.png",
...
public final class PreferencesOptionsPanelController extends OptionsPanelController {
	...
	public void applyChanges() {
		...
		// This will cause PreferencesImpl to fire a PropertyChange
		Lookup.getDefault().lookup(Preferences.class).update();
		changed = false;
	}
